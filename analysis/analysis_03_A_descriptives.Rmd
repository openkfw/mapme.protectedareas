...
for (i in T_year) {
  ...
  m_out1 <- read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/CEM/t3/m_cem_t3_", i, ".rds"))
  ...
  m_out1 <- read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/PSM/t3/m_psm_t3_", i, ".rds"))
...
get_descriptives <- function(year) {
  ...
  m_psm <- 
    read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/PSM/t3/m_psm_t3_", year, ".rds"))
  m_cem <- 
    read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/CEM/t3/m_cem_t3_", year, ".rds"))
