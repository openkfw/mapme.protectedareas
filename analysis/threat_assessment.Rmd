...
The advantage of Jitter Plots  is that individual data-points (PAs) can be identified by clicking on them in the figure. Jitter Plots allow to visualize the (highly right-skewed) data distribution in an intuitive way and compare KfWs portfolio (**here shown with black dots**)or a suggested set of new PAs to the whole country universe.
