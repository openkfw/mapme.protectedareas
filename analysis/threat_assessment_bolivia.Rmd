...
my_map <-
  ...
  addLayersControl(
    ...
    overlayGroups = c("PAs KfW-supported","PAs (Others)", "Active Fires (2000-2021)", "Relative Forest Loss (2001-2020)","Forest Cover Loss (2001-2020)", "Regional Primary Forests (2001)"),
    options = layersControlOptions(collapsed = FALSE)) %>%
  # ommit certain layers
  hideGroup(group = c("Relative Forest Loss (2001-2020)", "PA Area Size","Forest Cover Loss (2001-2020)", "Regional Primary Forests (2001)"))
