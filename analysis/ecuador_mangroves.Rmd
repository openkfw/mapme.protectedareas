...
if (FALSE) {
  ...
  st_write(gadm_mangroves, dsn = fname_ecu, layer = "gadm_mangroves")
}
...
ts_gadm_mangroves %<>%
  ...
  select(contains("m_area_") | is_pa | id | region_name)
ts_pas_mangroves %<>%
...
In addition, we can look at the mean changes and see a clearer picture of the drastic changes, especially outside PAs before 2010.
