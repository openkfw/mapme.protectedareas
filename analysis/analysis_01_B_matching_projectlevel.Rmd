...
for (i in T_year) {
  ...
  # Load data
  df <- 
    read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matching_frames/projects/",i)) %>% 
    select(.assetid,
           treatment,
...
#  tryCatch({
    ...
    ## Export data
    # write_csv(m_data1, 
    #       paste0("../../datalake/mapme.protectedareas/output/tabular/regression_input/PSM/ps_matched_data_", bmz, ".csv"))
    write_rds(m_data1, 
