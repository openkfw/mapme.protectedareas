...
for (i in T_year) {
  ...
  mp_cem <- 
    read_csv(paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/CEM/tn/cem_tn_matched_panel_", i, ".csv")) %>% 
  ...
  mp_psm <- 
    read_csv(paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/PSM/tn/psm_tn_matched_panel_", i, ".csv")) %>% 
    mutate(fc_area_weighted = fc_area * weights)
