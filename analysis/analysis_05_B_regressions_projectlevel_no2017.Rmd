...
bmz_list <- bmz_list[-which(bmz_list=="201768464")] #skip because no focus on protection
...
for (bmz in bmz_list) {
 ...
 # create time varying treatment variable
  panel.df <- panel.df %>% 
    mutate(treatment_bmz = first_year_bmz<=year,
      treatment_disb = (treatment* treatment_bmz),
...
modelsummary(m_list1,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table1_cluster_tn_no2017.html",
...
modelsummary(m_list1,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table1_cluster_tn_no2017.tex",
             coef_rename = c("fc_loss" = "Forest cover loss", 
                             "treatment_disbTRUE" = "KfW support"),
             stars = TRUE,
             gof_map = c("nobs", "adj.r.squared", "FE: .assetid", "FE: year"),
...
m12_output %>%
  ...
  save_kable(file = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table1_cluster_style_tn_no2017.html", self_contained = T)
...
m12_output %>%
  kable_classic(full_width = F, html_font = "Cambria") %>%
  column_spec(1, width = "8em") %>%
  save_kable(file = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table1_cluster_style_tn_no2017.tex")
...
modelsummary(m_list2,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table2_cluster_tn_no2017.html",
...
modelsummary(m_list2,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table2_cluster_tn_no2017.tex",
             coef_rename = c("fc_area" = "Forest cover area", 
                             "treatment_disbTRUE" = "KfW support"),
             stars = TRUE,
             gof_map = c("nobs", "adj.r.squared", "FE: .assetid", "FE: year"),
...
modelsummary(m_list3,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table3_cluster_tn_no2017.html",
...
modelsummary(m_list3,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/tn_projects/table3_cluster_tn_no2017.tex",
             coef_rename = c("emissions" = "Emissions from deforestation", 
                             "treatment_disbTRUE" = "KfW support"),
             stars = TRUE,
             gof_map = c("nobs", "adj.r.squared", "FE: .assetid", "FE: year"),
