...
m_list1_no2019 <- list(m12_2004, m12_2005, m12_2006, m12_2007, m12_2008, m12_2009, m12_2010, m12_2011, m12_2012, m12_2013, m12_2014, m12_2015, m12_2016, m12_2017, m12_2019)
m_list2_no2019 <- list(m22_2004, m22_2005, m22_2006, m22_2007, m22_2008, m22_2009, m22_2010, m22_2011, m22_2012, m22_2013, m22_2014, m22_2015, m22_2016, m22_2017, m22_2019)
m_list3_no2019 <- list(m32_2004, m32_2005, m32_2006, m32_2007, m32_2008, m32_2009, m32_2010, m32_2011, m32_2012, m32_2013, m32_2014, m32_2015, m32_2016, m32_2017, m32_2019)
...
names(m_list1_no2019) <- c(2004:2017)
names(m_list2_no2019) <- c(2004:2017)
names(m_list3_no2019) <- c(2004:2017)
```
...
# Output: fc_loss
modelsummary(m_list1_no2019,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/table1_cluster_no2019.html",
...
m12_output_no2019 <- modelsummary(m_list1_no2019,
               coef_rename = c("fc_loss" = "Forest cover loss",
                               "treatment_disbTRUE" = "KfW support"),
               stars = TRUE,
               gof_map = c("nobs", "adj.r.squared", "FE: .assetid", "FE: year"),
...
m12_output %>%
  ...
  save_kable(file = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/table1_cluster_style_no2019.html", self_contained = T)
...
# Output: fc_area
modelsummary(m_list2_no2019,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/table2_cluster_no2019.html",
...
# Output: emissions
modelsummary(m_list3_no2019,
             output = "/datadrive/datalake/mapme.protectedareas/output/tabular/regression_output/table3_no2019.html",
...
# Create coefficient plot for fc_loss 
modelplot(m_list1_no2019, background = b)
# Create coefficient plot for fc_area
modelplot(m_list2_no2019, background = b)
# Create coefficient plot for emissions
modelplot(m_list3_no2019, background = b)
```
