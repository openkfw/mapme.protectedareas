...
for (i in T_year) {
    ...
    # Load matched data
    m_data <-
      read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/PSM/tn/psm_tn_matched_data_", i, ".rds")) %>%
 ...
 "traveltime_5k_110mio", "traveltime_20k_110mio", "terrain_ruggedness_index_mean", "elevation_mean", "soil_5_15cm_clay", "NAME_0", "distance", "weights")
    ...
    write_csv(merged_data,
              paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/PSM/tn/psm_tn_matched_panel_", i, ".csv"))
...
for (i in T_year) {
    ...
    # Load matched data
    m_data <- 
        read_rds(paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/CEM/tn/cem_tn_matched_data_", i, ".rds")) %>%
      rename("m_treecover" = "treecover",
             "m_loss" = "loss",
             "m_loss_tn" = "loss_tn",
             # "m_loss_tn" = "loss_tn",
 ...
 "traveltime_5k_110mio", "traveltime_20k_110mio", "terrain_ruggedness_index_mean", "elevation_mean", "soil_5_15cm_clay", "NAME_0", "weights")
    ...
    ## Export data
    write_csv(merged_data, 
              paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/CEM/tn/cem_tn_matched_panel_", i, ".csv"))
