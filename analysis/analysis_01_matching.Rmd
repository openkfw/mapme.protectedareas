...
#  tryCatch({
    ...
    write_rds(m_data1, 
            paste0("../../datalake/mapme.protectedareas/output/tabular/regression_input/PSM/psm_matched_data_", i, ".rds"))
...
```{r matching frame 2003}
# Assign values to input parameters
cutoffs_travel_time <- c()
cutoffs_loss_t3 <- c()
cutoffs_elevation <- c()
cutoffs_tri <- c()
cutoffs_soil <- c()
year <- 2003
# Call function
custom_cem(year = year, cutoffs_travel_time = cutoffs_travel_time, cutoffs_loss_t3 = cutoffs_loss_t3,cutoffs_elevation = cutoffs_elevation)
```
