...
custom_cem <- function(year, cutoffs_travel_time, cutoffs_loss_t3, cutoffs_elevation, cutoffs_tri, cutoffs_soil) {
  ...
  # Save matchit object
  write_rds(m_out2, paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/CEM/TEST_m_cem_", year, ".rds"))
  ...
  write_rds(m_data2, 
            paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/CEM/cem_matched_data_", year, ".rds"))
