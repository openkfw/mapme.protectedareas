...
#  tryCatch({
    ...
    stargazer(glm_out1,
              ...
              out = paste0("/output/plots/propensity_score_matching/probit_summary_",i,".html"))
    ...
    # Save matchit object
    saveRDS(m_out1, paste0("./output/matching/matchit_objects/PSM/m_psm_", i, ".rds"))
...
cutoffs_list$travel_time_to_nearby_cities_min_5k_100mio <-
  c(0,120,300, 400, 500, 600, 800, 1000, 1500, 2000, 3000, max(df_match$travel_time_to_nearby_cities_min_5k_100mio,na.rm = T)) # 0-2hrs, 2-6 hrs, >6 hrs
cutoffs_list$terrain_ruggedness_index_mean <- c(0,5,10,max(df_match$terrain_ruggedness_index_mean,na.rm = T))
cutoffs_list$elevation_mean <- c(0,500,1500,max(df_match$elevation_mean,na.rm = T))
cutoffs_list$sum_fcl_matchingyear_tmax <- c(-1,0, 1, 10, 100, 200, 300, 400, 500, 600, 1000, max(df_match$sum_fcl_matchingyear_tmax))
...
#  tryCatch({
    ...
    # Save matchit object
    saveRDS(m_out2, paste0("./output/matching/matchit_objects/CEM/m_cem_", i, ".rds"))
