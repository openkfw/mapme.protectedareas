...
#  tryCatch({
    ...
    # Save matchit object
    write_rds(m_out1, paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/PSM/t3/m_psm_t3_", i, ".rds"))
    ...
    write_rds(m_data1, 
            paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/PSM/t3/psm_t3_matched_data_", i, ".rds"))
...
custom_cem <- function(year, cutoffs_travel_time, cutoffs_loss_t3, cutoffs_elevation, cutoffs_tri, cutoffs_soil) {
  ...
  # Save matchit object
  write_rds(m_out2, paste0("/datadrive/datalake/mapme.protectedareas/output/matching/matchit_objects/CEM/t3/m_cem_t3_", year, ".rds"))
  ...
  write_rds(m_data2, 
            paste0("/datadrive/datalake/mapme.protectedareas/output/tabular/regression_input/CEM/t3/cem_t3_matched_data_", year, ".rds"))
