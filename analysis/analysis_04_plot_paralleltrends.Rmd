...
for (i in T_year) {
  ...
  cem_min <- min(mp_summarized_cem$mean_fca)
  cem_max <- max(mp_summarized_cem$mean_fca)
  ...
  psm_min <- min(mp_summarized_psm$mean_fca)
  psm_max <- max(mp_summarized_psm$mean_fca)
