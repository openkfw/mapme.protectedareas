...
total_loss_avoided <- loss_effect * obs_treated

total_emissions_avoided <- as.numeric(as.vector(est_table_emissions[1,2:(length(all_years) + 1)])) * as.numeric(as.vector(obs_table_emissions[2,2:(length(all_years) + 1)])) * 500 # is it correct to multiply by 500? bc estimate for tons per ha
