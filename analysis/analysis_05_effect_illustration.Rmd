...
# total
totals <- c(sum(total_treated_area),
            sum(total_loss_avoided),
            sum(total_emissions_avoided),
            sum(disbursement),
            sum(disbursement_per_ha),
            sum(eur_per_avoided_ton))
...
names(effects_table) <- c(all_years, "2004-2015")
